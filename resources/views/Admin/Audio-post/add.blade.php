            ...
            <div class="col-md-8  py-2 order-md-first">
                <div class="card ">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="mb-0">Audio post add</h3>
                        <hr>
                    </div>
                    <div class="card-body">
                        <div class="card_body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade" id="embed" role="tabpanel">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <textarea class="form-control" name="embed_link" placeholder="Enter audio embed link here"></textarea>
                ...
                <div class="card ">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="error text-danger"> @error('thumbnail')
                                    {{ $message }}
                                @enderror
                            </div>
                        </div>
